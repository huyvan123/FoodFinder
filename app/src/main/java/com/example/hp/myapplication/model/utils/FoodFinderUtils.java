...
public interface FoodFinderUtils {
    ...
    public static final String SOUNTHWEST = "southwest";
    ...
    public static final String FORMATTED_PHONENUMBER = "formatted_phone_number";
    public static final String INTERNATIONAL_PHONENUMBER = "international_phone_number";
    public static final String OPENING_HOURS = "opening_hours";
    public static final String OPEN_NOW = "open_now";
    public static final String WEEK_DAY_TEXT = "weekday_text";
    public static final String RATING = "rating";
    public static final String WEBSITE = "website";


    public static final String PLACES_API_BASE = "https://maps.googleapis.com/maps/api/";
    public static final String TYPE_PLACE_PHOTO = "place";
